...
alias gcpp='g++ -Wall -Wextra -Werror -pedantic -std=c++17'
...
alias pull='git pull'
alias tag='git tag -a'
alias putag='git push --tags'
alias log='git shortlog'
alias logs='git shortlog -s'
alias status='git status'
alias diff='git diff'
alias stash='git stash'
alias stashpop='git stash pop'
alias logp='git log --graph --full-history --all --pretty=format:"%h%x09%d%x20%s"'
...
# 2 functions in bash to simplify your life when you don't want to type the
